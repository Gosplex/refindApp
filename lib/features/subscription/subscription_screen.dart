...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
  ...
  int get _savingPercent {
    ...
    final savings              = ((yearlyCostIfMonthly - yearly) / yearlyCostIfMonthly) * 100;
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _loading
                      ? _ShimmerBlock(width: double.infinity, height: 46, radius: 12, isDark: isDark)
                      : _BillingToggle(
                    isYearly:      _isYearly,
                  ...
                  _loading
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Expanded(child: _ShimmerBlock(width: double.infinity, height: 200, radius: 16, isDark: isDark)),
                  ...
                  Text('What you get', style: Theme.of(context).textTheme.titleSmall),

                  const SizedBox(height: 12),

                  _loading
                      ? _ShimmerBlock(width: double.infinity, height: 160, radius: 16, isDark: isDark)
...
class _ShimmerBlockState extends State<_ShimmerBlock>
  ...
  @override
  Widget build(BuildContext context) {
    final base = widget.isDark ? AppColors.surfaceDark        : AppColors.surfaceVariant;
            ...
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border:       !isYearly ? Border.all(color: borderColor, width: 0.8) : null,
                ),
                child: Center(
                  child: Text(
                    'Monthly',
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: const Icon(Icons.bookmark_rounded, size: 22, color: AppColors.primary),
        ),
        const SizedBox(height: 16),
        Text('Unlock the full\npower of Refind', style: Theme.of(context).textTheme.headlineSmall),
        const SizedBox(height: 8),
        Text('Save without limits and revisit what matters.', style: Theme.of(context).textTheme.bodyMedium),
      ],
    );
  }
}
...
class _PlanCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final bg           = highlight ? AppColors.primaryMuted : (isDark ? AppColors.surfaceDark : AppColors.surface);
    final borderColor  = highlight ? AppColors.primaryLight  : (isDark ? AppColors.borderDark  : AppColors.border);
    final titleColor   = highlight ? AppColors.primary       : (isDark ? AppColors.textSecondaryDark : AppColors.textSecondary);
    final priceColor   = highlight ? AppColors.primary       : (isDark ? AppColors.textPrimaryDark   : AppColors.textPrimary);
    final featureColor = highlight ? AppColors.primary       : (isDark ? AppColors.textSecondaryDark : AppColors.textSecondary);
    ...
    return AnimatedContainer(
      ...
      child: Column(
        ...
        children: [
          Text(
            title.toUpperCase(),
            style: TextStyle(fontSize: 11, fontWeight: FontWeight.w500, color: titleColor, letterSpacing: 0.8),
          ),
          const SizedBox(height: 8),
          RichText(
            text: TextSpan(children: [
              TextSpan(
                text: price,
                style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: priceColor, height: 1.1),
              ),
              TextSpan(
                text: ' $period',
                style: TextStyle(fontSize: 11, fontWeight: FontWeight.w400, color: titleColor),
              ),
            ]),
          ),
          if (perMonthNote != null) ...[
            ...
            Text(
              perMonthNote!,
              style: TextStyle(fontSize: 10, fontWeight: FontWeight.w400, color: titleColor.withValues(alpha: 0.7)),
            ),
          ],
          ...
          ...features.map((f) => Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 6),
                Expanded(
                  child: Text(f, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: featureColor, height: 1.4)),
                ),
              ],
            ),
          )),
          ...
          return Column(
            children: [
              ...
              if (i < _features.length - 1)
                Divider(height: 0, thickness: 0.8, color: borderColor, indent: 56, endIndent: 16),
            ],
          );
        }),
      ),
